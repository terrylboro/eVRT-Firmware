 ...
 * SPIM00 on nRF54L15 uses a 128 MHz source with an even prescaler. 1.28 MHz
 * maps exactly to divisor 100 and stays comfortably below the ADS1292R limit.
 */
...
int ads1292r_init(void)
{
    ...
    printk("ADS init: configuring internal test signal\n");
